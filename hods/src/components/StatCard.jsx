export default function StatCard({ title, value, subtitle, icon: Icon, color = 'fuchsia' }) {
  const colorMap = {
    fuchsia: 'from-fuchsia-500/20 to-pink-500/10 border-fuchsia-500/30 text-fuchsia-400',
  ...
  return (
    <div className={`p-5 rounded-2xl bg-gradient-to-br ${colorMap[color] || colorMap.fuchsia} border glass-card transition-all duration-200`}>
