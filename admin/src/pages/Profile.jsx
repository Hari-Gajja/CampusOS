...
import { User, Mail, Save, CheckCircle2, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Manage system administrator identity details</p>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-900 border border-slate-800 text-white text-sm focus:outline-none focus:border-rose-500"
                />
              </div>
            </div>
